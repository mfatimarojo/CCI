...
/**
 * This class is the "main" class of the vancarrier_1st_p model. It is derived
 * from desmoj.model and consists of all the needed infrastructural issues of a
 * DESMO-J based model. It provides all random streams , queues, descriptions,
 * and simulation steering needed. See the method comments for further
 * information.
 *
...
public class VancarrierModel extends Model implements Parameterizable {
	...
	/**
	 * Random stream used to draw an arrival time for the next truck. See
	 * Vancarrier_1st_p_model.init() method for stream parameters.
	 */
	private ContDistExponential truckArrivalTime;

	/**
	 * Random stream used to draw a service time for this truck. Describes the
	 * time needed by the VC to get and load the container on the truck. See
	 * Vancarrier_1st_p_model.init() method for stream parameters.
	 */
	 ...
	 * for the next truck to come. (Note: We don't use a status field here due
	 ...
	 *
	 * Creates a new Vancarrier_1st_p model with calling the superclasses
	 * constructor.
	 *
	 * @param owner
	 *            desmoj.Model
	 ...
	 *            boolean
	 */
	public VancarrierModel(Model owner, String modelName, boolean showInReport, boolean showInTrace) {
	...
	/**
	 * Default Constructor for use with Launcher. showInReport and showInTrace
	 * are set to true.
	 */
	 ...
	 *
	 * In this case a first truck arrival and the vancarrier are neceesary
	 * entries.
	 */
	...
	/**
	 * Returns a sample out of the random stream used to measure time needed to
	 * find the container for this truck in the storage and the time the VC
	 * needs to get it to the truck.
	 * 
	...
	/**
	 * Returns a sample out of the random stream used to measure the next truck
	 * arrival time.
	 *
	...
	/**
	 * This method is used to initialize all DESMO-J infrastructure we use
	 */
	public void init() {
	 ...
	 * outputs - start the simulation - set the ending criteria (normally the
	 * time) - initiate reporting - clean up the experiment
	 *
	 * @param args
	...
	/**
	 * Returns the model parameters: vcNumber : Number of VCs working in the
	 * yard.
	 */
